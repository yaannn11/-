...
if __name__ == "__main__":
    ...
    summary_stats = write_report(results_dict, functions, seeds, base_dir)        

    plot_convergence(results_dict, functions, seeds, base_dir)
    plot_performance(summary_stats, functions, base_dir)
    export_all(results_dict, functions, seeds, base_dir)
