...
<img width="500" height="300" alt="image" src="https://github.com/user-attachments/assets/e5d60080-4f54-4919-a133-21280ee3d072" />

### 實驗結果顯示 : 
提出的改良版 ESA 展現出優異的搜尋表現與泛化能力。在 Ackley 函數上，將平均最佳解降低了約 55%，標準差從 0.192 顯著降至 0.0098，證實在優化效率與搜尋穩定性上皆有大幅度的提升；同時，在 Ellipsoid 與 Rosenbrock 函數中，在平均值和標準差上取得雙重改善，維持了高度的穩定搜尋品質。在 Griewank、RHC1 與 RHC2 等多峰或特定地形函數中，因為 Adaptive Temperature 機制動態調整了探索與利用的平衡，可能使演算法在有限的評估次數（NFE）內未能完全收斂，導致結果略遜於原始 ESA。
* 30D.50D.100D的個別結果(txt檔)存放在各維度資料夾中，而各個圖表存放在各維度的資料夾的charts資料夾中
